...
public class ClusterClient {
	...
	private ClusterClient(EventLoopGroup group, String hosts) {
	...
	public static ClusterClient create(String hosts) {
		return create(new NioEventLoopGroup(), hosts);
	}

	public static ClusterClient create(EventLoopGroup group, String hosts) {

		return new ClusterClient(group, hosts);
	}
